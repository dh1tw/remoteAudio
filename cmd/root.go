...
func init() {
	...
	RootCmd.PersistentFlags().Float64("pcm-samplerate", 16000, "pcm sampling rate")
	RootCmd.PersistentFlags().Int("pcm-bitdepth", 16, "pcm audio bit depth (8, 12, 16, 24 bit)")
	RootCmd.PersistentFlags().Int("pcm-channels", 2, "pcm audio Channels")
	...
	viper.BindPFlag("pcm.samplerate", RootCmd.PersistentFlags().Lookup("pcm-samplerate"))
