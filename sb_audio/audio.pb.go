...
func (*State) Descriptor() ([]byte, []int) {
	return fileDescriptor_fae679ade197b92f, []int{4}
}
...
func skipAudio(dAtA []byte) (n int, err error) {
	...
	for iNdEx < l {
		...
		case 4:
			if depth == 0 {
				return 0, ErrUnexpectedEndOfGroupAudio
			}
			depth--
		case 5:
			iNdEx += 4
